...
export default class NotificationScreen extends React.Component {
    ...
    sendPushNotification = async () => {
        const message = {
            ...
            sound: 'default',
            title: 'Daily Offers',
            body: 'check out this amazing offer',
            data: { text: this.state.data },
        };
        ...
        return (
            <View
                ...
                <View style={{ alignItems: 'center', justifyContent: 'center' }}>
                    <Text>Data: {this.state.notification.data.text}</Text>
                </View>
                <TextInput
                    ...
                    style={{ paddingBottom: '3%', paddingLeft: '5%', width: 200 }}
                />
                <Button
